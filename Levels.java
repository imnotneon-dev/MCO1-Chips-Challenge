...
public class Levels {
     ...
     * 
     * @return - it returns the current map layout for level 1 for the Display class to use
     */
     ...
     * 
     * @return - returns the current map layout for level 2 for the Display class to use
     */
     ...
     * 
     * @return - returns the current map layout for level 3 for the Display class to use
     */
     ...
     * 
     * @return - the map layout being used
     */
    public char[][] getMap() {
        return map;
    }
     ...
     * 
     * @return - the chips required to pass the current map level
     */
    public int getChips() {
        return chips;
    }
